...
/* Standard interface: INTERFACENAME, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO INTERFACENAME_ProxyInfo;
    ...
    /* [string][in] */ unsigned char *Path)
{
    ...
    _RetVal = NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&INTERFACENAME_ProxyInfo,
                  0,
                  0,
                  hBinding,
                  Path);
...
static const MIDL_STUB_DESC INTERFACENAME_StubDesc = 
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& INTERFACENAME_ProxyInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const MIDL_STUBLESS_PROXY_INFO INTERFACENAME_ProxyInfo =
    {
